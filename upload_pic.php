...
***********************************************************/	
	...
	//Set Upload directory    
		$uploaddir = $_SERVER['DOCUMENT_ROOT'].'/stacktracks/assets/images/profile_pics';
	//Set File name	
...
<div>
	...
	<div class="well" id="formExample" style="position: relative; width: 50%; top: 50%; left: 25%; border-radius: 10px; border: ">
		
	    <p><b> <?=$msg?> </b></p>
	    <form action="upload_pic.php" method="post" class="text-center" enctype="multipart/form-data">
	        <h2 style="padding: 20px;">Upload Your Profile Picture</h2><br /><br />
	        <input type="file" id="image" name="image" required style="position: relative; left: 43.5%;" /><br /><br />
	        <input type="submit" value="Submit" style="font-size: 14px; background-color: #0984e3; border: none; border-radius: 5px; padding: 4px 8px; color: #fff; cursor: pointer;" />
	    </form><br /><br />
    ...
    if($imgSrc){ //if an image has been uploaded display cropping area?>
	    ...
	    <div id="CroppingContainer" style="width:800px; max-height:600px; background-color:#FFF; margin-left: -200px; position:relative; overflow:hidden; border:2px #666 solid; z-index:2001; padding-bottom:0px;">  
	        ...
	        <div id="CropImageForm" style="width:100px; height:30px; float:left; margin:10px 0px 0px 40px;" >  
	            <form action="upload_pic.php" method="post" onsubmit="return checkCoords();">
	        ...
	        <div id="CropImageForm2" style="width:100px; height:30px; float:left; margin:10px 0px 0px 40px;" >  
	            <form action="upload_pic.php" method="post" onsubmit="return cancelCrop();">
